...
// const total = players.reduce((acc, player) => acc + player.timePlayed);
...
// function getSortedCarsOnSale(array) {
//   return array
//     .filter(item => !item.onSale) // фільтрую авто на розпродажі
//     .toSorted((a, b) => a.price - b.price) // сортую за ціною
// }
